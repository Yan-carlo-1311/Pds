...
def main(options):
    if options[1] == "Tarea_1":
        if len(options) < 3:
            print("Que señal quieres : seno, exponencial, triangular, cuadrada")
            return
        ...
        if signal_type == "seno":
            ...
            print("No tengo de esa Usa: seno, exponencial, triangular o cuadrada.")
        ...
        print("No lo escrbiste bien . Usa: Tarea_1 o Tarea_2")
...
if __name__ == '__main__':
    ...
    if len(args) > 1:
        ...
        print("Dame un argumento un argumento")
        print("Ejemplos:")
